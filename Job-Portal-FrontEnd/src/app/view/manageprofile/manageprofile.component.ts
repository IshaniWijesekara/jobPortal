...
export class ManageprofileComponent implements OnInit {
  ...
  constructor(private elem:ElementRef,private authService:AuthService,private jobPosterService:JObPosterService,private jobPosterProfleService:JobPosterProfileService) { }
